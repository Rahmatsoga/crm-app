    ...
    <div className="min-h-screen flex items-center justify-center bg-paper px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <div className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-accent text-white font-semibold mono mb-3">X</div>
          <h1 className="text-xl font-semibold text-ink">XYZ Software House</h1>
          <p className="text-sm text-ink/60 mt-1">Client relationship workspace</p>
        </div>
        ...
        <div className="bg-white border border-line rounded-xl p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            {error && (
              <p className="text-xs text-danger bg-dangerSoft border border-danger/20 rounded-lg px-3 py-2">{error}</p>
            )}
